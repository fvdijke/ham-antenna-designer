...
DRAWING = {
    "en": {
        ...
        "total_label": "Total length: {length}",
        "height_label": "Apex height: {length}",
        "feedpoint_marker": "FEEDPOINT",
        "core_tag": "core →",
        "shield_tag": "shield →",
    ...
    "nl": {
        ...
        "disc_label": "Disc: {length}",
        "cone_label": "Cone: {length}",
        "total_label": "Totale lengte: {length}",
        "height_label": "Apexhoogte: {length}",
        "feedpoint_marker": "VOEDINGSPUNT",
        "core_tag": "Core →",
        "shield_tag": "Shield →",
