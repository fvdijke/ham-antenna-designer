...
def _scene3d_vertical(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.feed3((0, 0, 0))
    b.tag3((0, 0, 0), 100, -80, t["core_tag"], "core")
    b.tag3((0, 0, 0), -150, 80, t["shield_tag"], "shield")
    b.balun3((0, 0, 0), -150, -80, design.balun["type"])
...
def _scene3d_horizontal_center_fed(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.tag3((0, support_h, 0), 100, -80, t["core_tag"], "core")
    b.tag3((0, support_h, 0), -150, 80, t["shield_tag"], "shield")
    b.balun3((0, support_h, 0), -150, -80, design.balun["type"])
...
def _scene3d_horizontal_loop(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.feed3(feed)
    b.tag3(feed, 100, -80, t["core_tag"], "core")
    b.tag3(feed, -150, 80, t["shield_tag"], "shield")
    b.balun3(feed, -150, -80, design.balun["type"])
...
def _scene3d_inverted_v(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.feed3(apex)
    b.tag3(apex, 100, -80, t["core_tag"], "core")
    b.tag3(apex, -150, 80, t["shield_tag"], "shield")
    b.balun3(apex, -150, -80, design.balun["type"])
...
def _scene3d_j_pole(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.feed3(tap)
    b.balun3(tap, -150, -80, design.balun["type"])
...
def _scene3d_yagi(design: AntennaDesign, units: str, lang: str, margin: float) -> Scene:
    ...
    b.tag3((0, h, z_driven), 100, -80, t["core_tag"], "core")
    b.tag3((0, h, z_driven), -150, 80, t["shield_tag"], "shield")
    b.balun3((0, h, z_driven), -150, -80, design.balun["type"])
